...
To reduce the package size of other R packages with Java GUIs and to reduce jar file conflicts,
this package provides a few commonly used Java libraries.

You should be able to load them by calling the rJava \texttt{.jpackage} function (a good place is most likely the \texttt{.onLoad} function of your package):
...
\begin{itemize}
 ...
 \item SGTK under BSD License, \url{http://www.algorithm-forge.com/rjavaclient/}, Copyright (c) 2007-2010 by Bernd Bischl and Kornelius Rohmeyer 
 \item MySQL-Connector under GPL 2, \url{http://www.mysql.com/downloads/connector/j/}, Copyright (c) 2000, 2010 by Oracle and/or its affiliates
 \item JRIEngine and REngine under LGPL-2.1, \url{http://www.rforge.net/rJava/}, Copyright 2010 by Simon Urbanek 
 \item InfoNode Docking Windows under GPL-2, \url{http://www.infonode.net/index.html?idw}, Copyright 1998-2009 NNL Technology 	 
\end{itemize}
