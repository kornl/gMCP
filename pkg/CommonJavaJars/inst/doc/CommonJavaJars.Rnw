...
this package provides a few commonly used Java packages.

You should be able to load them by calling similar code 
as the following in the \texttt{.onLoad} function of your package:
