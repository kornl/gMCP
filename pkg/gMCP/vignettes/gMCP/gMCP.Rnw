...
And perhaps you want to use an TikZ editor with a preview pane like qtikz or ktikz.\footnote{\url{http://www.hackenberger.at/blog/ktikz-editor-for-the-tikz-language/}}
