...
We support entangled graphs as a new feature. 
You can add a second entangled graph by selecting "\emph{Extras $\rightarrow$ Add entangled graph}" from the menu.
