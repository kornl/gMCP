...
\subsection{Using the GUI}\hypertarget{maingui}{}
...
\section{Power Simulations}\index{power simulation}\hypertarget{power}{}
...
\section{Options and Import/Export}\hypertarget{options}{}
