...
If you not already have R then download the installer from the following URL
and use it to install
\href{http://cran.r-project.org/bin/windows/base/release.htm}{the latest release
of R}.
%the latest release of R: \url{http://cran.r-project.org/bin/windows/base/release.htm}
