...
\draw [draw=black,->,line width=1pt] (H1) to[auto] node[near start,above,fill=blue!20] {$1$} (H3);
\draw [draw=black,->,line width=1pt] (H2) to[auto] node[near start,above,fill=blue!20] {$1$} (H3);
\draw [draw=black,->,line width=1pt] (H3) to[auto] node[near start,above,fill=blue!20] {$1-\epsilon$} (H4);
\draw [draw=black,->,line width=1pt] (H3) to[auto] node[near start,above,fill=blue!20] {$\epsilon$} (H5);
\draw [draw=black,->,line width=1pt] (H4) to[auto] node[near start,above,fill=blue!20] {$1$} (H2);
\draw [draw=blue,->,line width=1pt] (H1) to[auto] node[near start,above,fill=blue!20] {$1$} (H3);
\draw [draw=blue,->,line width=1pt] (H2) to[auto] node[near start,above,fill=blue!20] {$1$} (H3);
\draw [draw=blue,->,line width=1pt] (H3) to[auto] node[near start,above,fill=blue!20] {$\epsilon$} (H4);
\draw [draw=blue,->,line width=1pt] (H3) to[auto] node[near start,above,fill=blue!20] {$1-\epsilon$} (H5);
\draw [draw=blue,->,line width=1pt] (H5) to[auto] node[near start,above,fill=blue!20] {$1$} (H1);
\end{tikzpicture}
