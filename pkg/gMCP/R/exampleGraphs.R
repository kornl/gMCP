...
#' Stuttgart, 1995; 3-18.
#' 
#' Maurer, W., & Bretz, F. (2012). Memory and other properties of multiple test
#' procedures generated by entangled graphs. Statistics in medicine.
#' 
...
Entangled1Maurer2012 <- function() {
	...
	attr(graph, "description") <- paste("Graph from Maurer and Bretz 2012",
			"",
			"Literature: Maurer, W., & Bretz, F. (2012). Memory and other properties of multiple test procedures generated by entangled graphs. Statistics in medicine.", sep="\n")
...
WangTing2014 <- function(nu, tau) {
  ...
  attr(graph, "description") <- paste("Graph from Wang and Ting 2014",
                                      ...
                                      "with \u03BD=1, \u2CA7=\\epsilon graph from figure 4 and",
                                      "with \u03BD=\\epsilon, \u2CA7=\\epsilon graph from figure 5.",
									  "",
