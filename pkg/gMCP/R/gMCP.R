...
#' MCP.  Note that for the parametric tests
...
#' 
#' Performs a sequentially rejective multiple test procedure on a graph given
#' unadjusted p-values.
#' 
...
#' without outgoing edges is set to 0 if it is removed.  Otherwise it keeps its
#' weight.
#' @return An updated graph of class \code{\link{graphMCP}}.
#' @author Kornelius Rohmeyer \email{rohmeyer@@small-projects.de}
